...
\frame[t]{\frametitle{Idea behind the book}
\begin{itemize}
 \item Learn you a Python -- for kids
 \item begin programming early 
 \item not just a nonfictional book
 \item instead a fantasy story 
 \item each chapter includes excercises
 \item aim: kids build first little project at the end      
\end{itemize}
}
...
%\frame[t]{\frametitle{}
%\vspace*{2 cm}
%\begin{block}{Fun with variables}
% Master the following challenges:
% \begin{itemize}
%  \item[a)] Create the variable \texttt{p} and assign the value 3 to it.
%  \item[b)] Create the variable \texttt{q} and assign the value 12 to it.
%  \item[c)] Compute \texttt{q/p} and save the result in the variable \texttt{r}.
%  \item[d)] Print the contents of all variables.
% \end{itemize}
%\end{block}
%}
...
\frame[t]{\frametitle{}
\vspace*{2,7 cm}
\begin{block}{Fun with swapping}
 Create also two variables \texttt{frog} and \texttt{duck} and assign some values to them which you can choose on your own.
 ...
 Now swap the contents of the two variables. Can you do that?
\end{block}
}
...
\frame[t]{\frametitle{}
 \vspace*{3 cm}
 \begin{center}
  \Large Sketches on GitHub: \\ \large \url{https://github.com/carinawi/monty-and-py}\par
 \end{center}
}
